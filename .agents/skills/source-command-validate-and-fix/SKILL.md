---
name: "source-command-validate-and-fix"
description: "Run quality checks and automatically fix issues using concurrent agents"
---

# source-command-validate-and-fix

Use this skill when the user asks to run the migrated source command `validate-and-fix`.
...
1. Check AGENTS.md/AGENTS.md for documented build/test/lint commands
