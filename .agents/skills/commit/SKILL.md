...
- Есть новые `V*.sql` → нужно добавить запись в `AGENTS.md` раздел "Recent Changes"
- Есть новые контроллеры/сервисы → нужно проверить раздел "Package Structure" в `AGENTS.md`
