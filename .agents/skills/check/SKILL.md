...
## 3. Docs reminder (mandatory per AGENTS.md)
If any zoomos/* files changed → "Update docs/zoomos-check.md"
If any V*.sql created → "Add to AGENTS.md Recent Changes section"
If new controller/service → "Check AGENTS.md Package Structure"
