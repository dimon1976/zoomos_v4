...
- После правки → `git add .Codex/agents/ .Codex/skills/ && git commit -m "chore: уточнена маршрутизация ..."`
...
| [`docs/Codex-setup.md`](docs/Codex-setup.md) | Агенты, скилы, команды, хуки — как пользоваться .Codex/ |
