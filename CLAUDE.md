...
✅ Чекбокс расписания на главной (с модальным подтверждением) + звёздочка приоритета в таблице сайтов
✅ Кнопки "Адреса" и "Удалить сайт" разнесены по отдельным столбцам таблицы
